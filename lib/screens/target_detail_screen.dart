...
class TargetDetailScreen extends StatefulWidget {
  final String id;
  const TargetDetailScreen({super.key, required this.id});
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Text(
                              "${type == "Weight Loss" ? type : target.keys.first} Target:",
                            ...
                            Text(
                              "${type == "Weight Loss" ? target['weightLoss'] : target[target.keys.first]} ${type == "Weight Loss" ? "kg" : "%"}",
                              style: const TextStyle(
